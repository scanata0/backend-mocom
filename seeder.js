...
const runSeeder = async () => {
  try {
    ...
    await db.query(
      "INSERT INTO companies (company_name, email, phone_number, address) VALUES ?",
      [[
        ["PT Maju Jaya", "admin@majujaya.com", "08123456789", "Surabaya"],
        ["PT Sejahtera Abadi", "info@sejahtera.com", "08234567890", "Jakarta"]
      ]]
    );
    ...
    await db.query(
      ...
      [[
        [1, 1, "Admin", "admin", "admin@mail.com", "123456"],
        [2, 1, "Staff 1", "staff1", "staff1@mail.com", "123456"],
        [2, 2, "Staff 2", "staff2", "staff2@mail.com", "123456"]
      ]]
    );
    ...
    await db.query(
      ...
      [[
        [1, "Morning Shift", "Daily Ops", "2025-01-01 08:00:00", "2025-01-01 12:00:00", "Room A"]
      ]]
    );
